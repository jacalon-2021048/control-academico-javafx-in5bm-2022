...
public class GenerarReporte{
    ...
    public void mostrarReporte(String nombreReporte, Map<String,Object>  parametros,String titulo){
        try{
            parametros.put("IMAGE_LOGO",PAQUETE_IMAGES+"fondo control.jpg");
    ...
    public void compilarReporte(String nombreReporteJrxml, Map<String,Object>  parametros,String titulo,String consultaSql){
